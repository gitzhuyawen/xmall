...
export default {
  ...
  created() {
    ...
    axios(`/mz/goods/productDet?productId=${this.$route.query.productId}`).then(req=>{
      console.log(req.data.result)
      this.product=req.data.result
       this.small=req.data.result.productImageSmall
       this.big=req.data.result.productImageSmall[0]
    })
