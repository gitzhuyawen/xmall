<template>
  <div class="home">
    ...
    <el-carousel-item v-for="item in banner" :key="item.id">
      ...
      <img v-if="item.picUrl2" class="img1 a" :src="item.picUrl2">
      <img v-if="item.picUrl3" class="img1 b" :src="item.picUrl3">
    </el-carousel-item>
  </el-carousel>
    </div>
      ...
      <section class="w mt30 clearfix" v-if="item.type===3">
          <m-shelf :title="item.name">
            <div slot="content" class="floors">
               <div class="imgbanner" v-for="(o,j) in item.panelContents" 
            :key="j" v-if="o.type===2 || o.type===3">
