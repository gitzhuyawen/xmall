        ...
        <div class="w-box">
          ...
          <div class="right-box">
            ...
            <div class="nav-aside">
              ...
              <div
                class="shop pr"
                @mouseenter="cartShowState(true),bbb(true)"
                @mouseleave="cartShowState(false),bbb(false)"
               
              >
                <router-link to="/cart"></router-link>
                <span class="cart-num">
                  <i class="num" :class="{no:totalNum == 0}">{{this.cartList.length}}</i>
                </span>
<!-- :v-show="bb"  @mouseenter="bbb(true)"
                @mouseleave="bbb(false)" -->

                <!-- 购物车显示 -->
                <div class="nav-user-wrapper pa active"  v-show="bb">
                  <div class="nav-user-list">
                    <div class="full">
                                  ...
                                  <div class="item-desc">
                                    <div class="cart-cell">
                                      ...
                                      <h6>
                                        ...
                                        <span class="price-num">{{goods.aa2}}</span>
                      ...
                      <div class="nav-cart-total">
                        <p>
                          共
                          <strong>{{this.cartList.length}}</strong> 件商品
                        </p>
                        <h5>
                          合计:
                          <span class="price-icon">¥</span>
                    ...
                    <div style="height: 313px;text-align: center" class="cart-con" v-if='false' >
                      <p>您的购物车竟然是空的!</p>
                    </div>
                  </div>
                </div>
  ...
  .user {
    ...
    > a {
      ...
      &:before {
        ...
        top: 0;
        @include wh(20px);
        background: url(../../public/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) -155px
          0;
...
.cart-con:before {
  ...
  width: 76px;
  height: 62px;
  background: url("../../public/cart-empty-new.png") no-repeat;
  background-size: cover;
}
</style>